...
var DashboardComponent = (function () {
    function DashboardComponent(_streamService, http) {
        ...
        this.crypto1 = { name: 'loading...', logourl: '', id: '' };
        this.crypto2 = { name: 'loading...', logourl: '', id: '' };
        this.crypto3 = { name: 'loading...', logourl: '', id: '' };
        this.crypto4 = { name: 'loading...', logourl: '', id: '' };
        this.crypto5 = { name: 'loading...', logourl: '', id: '' };
        this.crypto6 = { name: 'loading...', logourl: '', id: '' };
