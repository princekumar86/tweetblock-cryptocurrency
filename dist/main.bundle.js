...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.loadOldTweets = function () {
        ...
        this.http.get(tempURL)
            ...
            for (var _i = 0, _a = _this.result; _i < _a.length; _i++) {
                var res_2 = _a[_i];
                _this.messages_old_crypto2.push(res_2.field1json);
            }
        });
        ...
        this.http.get(tempURL)
            ...
            for (var _i = 0, _a = _this.result; _i < _a.length; _i++) {
                var res_3 = _a[_i];
                _this.messages_old_crypto3.push(res_3.field1json);
            }
        });
        ...
        this.http.get(tempURL)
            ...
            for (var _i = 0, _a = _this.result; _i < _a.length; _i++) {
                var res_4 = _a[_i];
                _this.messages_old_crypto4.push(res_4.field1json);
            }
        });
        ...
        this.http.get(tempURL)
            ...
            for (var _i = 0, _a = _this.result; _i < _a.length; _i++) {
                var res_5 = _a[_i];
                _this.messages_old_crypto5.push(res_5.field1json);
            }
        });
        ...
        this.http.get(tempURL)
            ...
            for (var _i = 0, _a = _this.result; _i < _a.length; _i++) {
                var res_6 = _a[_i];
                _this.messages_old_crypto6.push(res_6.field1json);
            }
        });
        ...
        this.http.get(tempURL)
            ...
            for (var _i = 0, _a = _this.result; _i < _a.length; _i++) {
                var res_7 = _a[_i];
                _this.messages_old_cryptoall.push(res_7.field1json);
            }
        });
    };
        ...
        if (this.loading1 == false) {
            ...
            setTimeout(function () {
                ...
                _this.http.get(tempURL)
                    ...
                    for (var _i = 0, _a = _this.result; _i < _a.length; _i++) {
                        var res_8 = _a[_i];
                        _this.messages_old_crypto1.push(res_8.field1json);
                    }
        ...
        if (this.loading2 == false) {
            ...
            setTimeout(function () {
                ...
                _this.http.get(tempURL)
                    ...
                    for (var _i = 0, _a = _this.result; _i < _a.length; _i++) {
                        var res_9 = _a[_i];
                        _this.messages_old_crypto2.push(res_9.field1json);
                    }
        ...
        if (this.loading3 == false) {
            ...
            setTimeout(function () {
                ...
                _this.http.get(tempURL)
                    ...
                    for (var _i = 0, _a = _this.result; _i < _a.length; _i++) {
                        var res_10 = _a[_i];
                        _this.messages_old_crypto3.push(res_10.field1json);
                    }
        ...
        if (this.loading4 == false) {
            ...
            setTimeout(function () {
                ...
                _this.http.get(tempURL)
                    ...
                    for (var _i = 0, _a = _this.result; _i < _a.length; _i++) {
                        var res_11 = _a[_i];
                        _this.messages_old_crypto4.push(res_11.field1json);
                    }
        ...
        if (this.loading5 == false) {
            ...
            setTimeout(function () {
                ...
                _this.http.get(tempURL)
                    ...
                    for (var _i = 0, _a = _this.result; _i < _a.length; _i++) {
                        var res_12 = _a[_i];
                        _this.messages_old_crypto5.push(res_12.field1json);
                    }
        ...
        if (this.loading6 == false) {
            ...
            setTimeout(function () {
                ...
                _this.http.get(tempURL)
                    ...
                    for (var _i = 0, _a = _this.result; _i < _a.length; _i++) {
                        var res_13 = _a[_i];
                        _this.messages_old_crypto6.push(res_13.field1json);
                    }
        ...
        if (this.loadingall == false) {
            ...
            setTimeout(function () {
                ...
                _this.http.get(tempURL)
                    ...
                    for (var _i = 0, _a = _this.result; _i < _a.length; _i++) {
                        var res_14 = _a[_i];
                        _this.messages_old_cryptoall.push(res_14.field1json);
                    }
